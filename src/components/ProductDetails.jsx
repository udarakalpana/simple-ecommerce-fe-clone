    ...
    return (
        <div
            ...
            <div className="px-5 pb-5">
                <a href="#">
                    <h5 className="text-xl font-semibold tracking-tight text-gray-900">Apple Watch Series 7
                ...
                <div className="flex items-center mt-2.5 mb-5">
                    ...
                    <span
                        className="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded-sm ms-3">5.0</span>
                </div>
